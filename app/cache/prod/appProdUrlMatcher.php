...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'app_core_homepage')), array (  '_controller' => 'App\\CoreBundle\\Controller\\DefaultController::indexAction',));
        }

        if (0 === strpos($pathinfo, '/siparis')) {
            // SiparisShow
            if (0 === strpos($pathinfo, '/siparis/show') && preg_match('#^/siparis/show/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'SiparisShow')), array (  '_controller' => 'App\\CoreBundle\\Controller\\SiparisController::showAction',));
            }

            // SiparisGoster
            if (0 === strpos($pathinfo, '/siparis/goster') && preg_match('#^/siparis/goster/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'SiparisGoster')), array (  '_controller' => 'App\\CoreBundle\\Controller\\SiparisController::gosterAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/app/core')) {
                if (0 === strpos($pathinfo, '/admin/app/core/siparis')) {
                    // admin_app_core_siparis_list
                    if ($pathinfo === '/admin/app/core/siparis/list') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'sonata.admin.siparis',  '_sonata_name' => 'admin_app_core_siparis_list',  '_route' => 'admin_app_core_siparis_list',);
                    }

                    // admin_app_core_siparis_create
                    if ($pathinfo === '/admin/app/core/siparis/create') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'sonata.admin.siparis',  '_sonata_name' => 'admin_app_core_siparis_create',  '_route' => 'admin_app_core_siparis_create',);
                    }

                    // admin_app_core_siparis_batch
                    if ($pathinfo === '/admin/app/core/siparis/batch') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'sonata.admin.siparis',  '_sonata_name' => 'admin_app_core_siparis_batch',  '_route' => 'admin_app_core_siparis_batch',);
                    }

                    // admin_app_core_siparis_edit
                    if (preg_match('#^/admin/app/core/siparis/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_core_siparis_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'sonata.admin.siparis',  '_sonata_name' => 'admin_app_core_siparis_edit',));
                    }

                    // admin_app_core_siparis_delete
                    if (preg_match('#^/admin/app/core/siparis/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_core_siparis_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'sonata.admin.siparis',  '_sonata_name' => 'admin_app_core_siparis_delete',));
                    }

                    // admin_app_core_siparis_show
                    if (preg_match('#^/admin/app/core/siparis/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_core_siparis_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'sonata.admin.siparis',  '_sonata_name' => 'admin_app_core_siparis_show',));
                    }

                    // admin_app_core_siparis_export
                    if ($pathinfo === '/admin/app/core/siparis/export') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'sonata.admin.siparis',  '_sonata_name' => 'admin_app_core_siparis_export',  '_route' => 'admin_app_core_siparis_export',);
                    }

                }

                if (0 === strpos($pathinfo, '/admin/app/core/urunler')) {
                    // admin_app_core_urunler_list
                    if ($pathinfo === '/admin/app/core/urunler/list') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'sonata.admin.urunler',  '_sonata_name' => 'admin_app_core_urunler_list',  '_route' => 'admin_app_core_urunler_list',);
                    }

                    // admin_app_core_urunler_create
                    if ($pathinfo === '/admin/app/core/urunler/create') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'sonata.admin.urunler',  '_sonata_name' => 'admin_app_core_urunler_create',  '_route' => 'admin_app_core_urunler_create',);
                    }

                    // admin_app_core_urunler_batch
                    if ($pathinfo === '/admin/app/core/urunler/batch') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'sonata.admin.urunler',  '_sonata_name' => 'admin_app_core_urunler_batch',  '_route' => 'admin_app_core_urunler_batch',);
                    }

                    // admin_app_core_urunler_edit
                    if (preg_match('#^/admin/app/core/urunler/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_core_urunler_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'sonata.admin.urunler',  '_sonata_name' => 'admin_app_core_urunler_edit',));
                    }

                    // admin_app_core_urunler_delete
                    if (preg_match('#^/admin/app/core/urunler/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_core_urunler_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'sonata.admin.urunler',  '_sonata_name' => 'admin_app_core_urunler_delete',));
                    }

                    // admin_app_core_urunler_show
                    if (preg_match('#^/admin/app/core/urunler/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_core_urunler_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'sonata.admin.urunler',  '_sonata_name' => 'admin_app_core_urunler_show',));
                    }

                    // admin_app_core_urunler_export
                    if ($pathinfo === '/admin/app/core/urunler/export') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'sonata.admin.urunler',  '_sonata_name' => 'admin_app_core_urunler_export',  '_route' => 'admin_app_core_urunler_export',);
                    }

                }

                if (0 === strpos($pathinfo, '/admin/app/core/musteri')) {
                    // admin_app_core_musteri_list
                    if ($pathinfo === '/admin/app/core/musteri/list') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'sonata.admin.musteri',  '_sonata_name' => 'admin_app_core_musteri_list',  '_route' => 'admin_app_core_musteri_list',);
                    }

                    // admin_app_core_musteri_create
                    if ($pathinfo === '/admin/app/core/musteri/create') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'sonata.admin.musteri',  '_sonata_name' => 'admin_app_core_musteri_create',  '_route' => 'admin_app_core_musteri_create',);
                    }

                    // admin_app_core_musteri_batch
                    if ($pathinfo === '/admin/app/core/musteri/batch') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'sonata.admin.musteri',  '_sonata_name' => 'admin_app_core_musteri_batch',  '_route' => 'admin_app_core_musteri_batch',);
                    }

                    // admin_app_core_musteri_edit
                    if (preg_match('#^/admin/app/core/musteri/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_core_musteri_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'sonata.admin.musteri',  '_sonata_name' => 'admin_app_core_musteri_edit',));
                    }

                    // admin_app_core_musteri_delete
                    if (preg_match('#^/admin/app/core/musteri/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_core_musteri_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'sonata.admin.musteri',  '_sonata_name' => 'admin_app_core_musteri_delete',));
                    }

                    // admin_app_core_musteri_show
                    if (preg_match('#^/admin/app/core/musteri/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_core_musteri_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'sonata.admin.musteri',  '_sonata_name' => 'admin_app_core_musteri_show',));
                    }

                    // admin_app_core_musteri_export
                    if ($pathinfo === '/admin/app/core/musteri/export') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'sonata.admin.musteri',  '_sonata_name' => 'admin_app_core_musteri_export',  '_route' => 'admin_app_core_musteri_export',);
                    }
